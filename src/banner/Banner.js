...
const Banner = () => {
  return (
    <div className="relative w-full max-h-[640px] h-[640px] bg-black" id="pricing">
      ...
      <div className="container z-10 grid justify-center w-full h-full grid-cols-2 gap-10 isolate banner">
        <div className="flex flex-col gap-[35px] justify-center text-white banner-left">
          <Logo className="text-[60px]"></Logo>
          <p className="text-semibold text-[36px] leading-[1.2] title">
...
accumsan et viverra justo commodo."
        ...
        <div className="flex items-center justify-end banner-right">
