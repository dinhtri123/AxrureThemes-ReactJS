...
accumsan et viverra justo commodo."
        ...
        <div className="flex items-center justify-center">
            <form className="w-[360px] h-[362px] bg-white rounded-sm">
                <p className="w-full h-[55px] bg-[#f5f5f5] flex justify-center items-center font-bold text-[20px]">Try Your <span className="text-orangeLight p-">FREE</span> Trial Today</p>
