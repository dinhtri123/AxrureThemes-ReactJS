...
accumsan et viverra justo commodo."
        ...
        <div className="flex items-center justify-center">
            <form className="w-[360px] h-[362px] bg-white rounded-md overflow-auto flex flex-col justify-between" auto>
                ...
                <div className="w-full px-[40px] flex flex-col justify-around items-start">
