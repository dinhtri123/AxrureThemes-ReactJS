...
accumsan et viverra justo commodo."
        ...
        <div className="flex items-center justify-center">
            <form className="w-[360px] h-[362px] bg-white rounded-md overflow-auto">
                ...
                <button className="w-full h-[55px] bg-orangeLight text-white font-semibold mt-[70px]">Get Started</button>
            </form>
        </div>
      </div>
    </div>
