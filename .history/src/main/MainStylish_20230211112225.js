...
const MainStylish = () => {
    return (
        ...
        <div className='absolute inset-0 z-0 opacity-50'>
            ...
            <Title text="STYLISH AXURE DESIGN" className={"text-white text-[30px] font-ligh title"}></Title>
            <span className="w-[60px] h-[2px] bg-white rounded-lg"></span>
            <Text content={"Use the sections you need, remove the ones you don't.  Create gorgeous prototypes faster than ever!"} className='text-white text-center'></Text>
