...
function Content({icon, title}){
    return(<div>
        ...
        <Text content={"conteLorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida 
dolor sit amet lacus accumsan et viverra.nt"}></Text>
