...
const MainAwesome = () => {
  return (
    <div className="bg-white py-[100px]" id="reviews">
      <div className="container flex flex-col gap-[30px] items-center">
        <h3 className="text-[30px] font-medium title">WHY THIS IS AWESOME</h3>
        <span className="w-[60px] h-[2px] bg-orangeLight rounded-lg"></span>
        <Text
         className="title"
          content={"Lorem ipsum dolor sit amet, consectetur adipiscing elit."}
        ></Text>
        <div className="grid grid-cols-3 gap-1 card">
          <Content
...
const Content = ({ icon, title }) => {
  return (
    <div className="flex flex-col gap-[25px] items-center py-10">
      ...
      <Text className="text-center leading-[1.2]"
        content={
