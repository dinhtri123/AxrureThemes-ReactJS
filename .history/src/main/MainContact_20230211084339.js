    ...
    return (
        <div className='w-full py-[100px] bg-white'>
            <div className="container flex flex-col gap-[30px] items-center justify-center">
                ...
                <textarea placeholder='Message' className='w-full h-full border-b-2 border-b-[#f5f5f5] p-5 outline-none'></textarea>
                </div>
                <div className='m-auto'>
                    <button className='font-medium text-white bg-orangeLight rouded-md w-[150px] h-[45px]'>Send Message</button>
                </div>
                </form>
            </div>
        </div>
