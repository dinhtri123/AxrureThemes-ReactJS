...
const MainContact = () => {
    return (
        <div className='w-full py-[100px] bg-white' id='contact'>
            <div className="container flex flex-col gap-[30px] items-center justify-center">
                ...
                <Text className='title' content={"Lorem ipsum dolor sit amet, consectetur adipiscing elit."}></Text>
                <form className='flex flex-col w-full gap-10' autoCapitalize='off'>
                <div className='grid grid-cols-2 gap-10 contact'>
                <div className='flex flex-col w-full gap-[30px] pt-[20px]'>
                    <Input type='text' name='name' placeholder={"Name"}></Input>
                    <Input type='email' name='email' placeholder={"Email"}></Input>
                    <Input type='text' name='subject' placeholder={"Subject"}></Input>
                </div>
                <textarea placeholder='Message' className='w-full h-full border-b-2 border-b-[#f5f5f5] p-5 outline-none placeholder:text-sm placeholder:text-[#cfcfcf]'></textarea>
                </div>
